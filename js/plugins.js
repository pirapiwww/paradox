...
{"name":"GalleryMenu","status":true,"description":"Adds a \"Gallery\" command to the Title Screen that opens the default Item menu (Item + Key Item only). MV compatible.","parameters":{}},
